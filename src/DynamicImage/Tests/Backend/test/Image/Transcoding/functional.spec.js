...
suite('Functional tests', () => {
  ...
  suiteSetup((done) => {
    ...
    const TEST_ASSERTS_DIR = '../../../../test/Image/Transcoding/test-asserts';
  ...
  test('Check lambdas', () => {
    ...
    for (i = 0; i < inputEventsArray.length; i++) {
      ...
      let cmd = `deepify run-lambda ../../../node_modules/deep-microservices-dynamic-image-transcoding/ -e=${eventStr} -p`;
